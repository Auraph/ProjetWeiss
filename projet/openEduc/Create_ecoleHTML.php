...
<script type="text/javascript">
		...
		<form method="POST" action="Create_ecolePHP.php">
            ...
            <p>Téléphone :</p>
			<input class="champs"  type="text" id="phoneEcole" name="phoneEcole" pattern="[0-9]{10}">
            ...
            <p>Fonction :</p>
			<input class="champs"  type="text" id="fonctionMaire" name="fonctionMaire">


            <h1>Classes</h1>

            <p>Niveau :</p>
			<input class="niveau champs"  type="text" name="niveau0">

            <p>Nom de la classe :</p>
			<input class="nomClasse champs"  type="text" name="nomClasse0">

            <p>Effectifs :</p>
			<input class="eff champs"  type="text" name="effectifs0">
